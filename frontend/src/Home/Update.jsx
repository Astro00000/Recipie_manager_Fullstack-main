...
function Update() {
  ...
  useEffect(() => {
    const fetchRecipe = async () => {
      try {
        const response = await axios.get(`https://recipiebackend.onrender.com/recipes/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await axios.put(`https://recipiebackend.onrender.com/recipes/${id}`, formattedData, {
            headers: { 
